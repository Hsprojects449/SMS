                ...
                renderCell: (params) => (
                    <Checkbox
                        ...
                        onChange={(e) => {
                            ...
                            setChanges((prev) => {
                                const exists = prev.some(row => row.StudentID == params.id && row.TimetableID == params.field.split(" ")[0]);
                                if (exists) {
                                    return prev.map((row) =>
                                        row.StudentID === params.id
                                            ? {
                                    ...
                                    return [
                                        ...prev,
                                        {
                                            ...
                                            Date: selectedDate,
                                            Status: newVal ? "Present" : "Absent",
                                            TimetableID: params.field.split(" ")[0],
    ...
    return (
        <div>
            ...
            <div ref={topRef} className="p-6 space-y-6">
                ...
                {selectedClass ? (<div className="bg-white text-black p-6 rounded-lg shadow space-y-4 border border-orange-300 overflow-auto">
