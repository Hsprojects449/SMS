...
const Marks = ({teacherData}) => {
    ...
    const selectedSubject = teacherData['subjectSpecialization'];
        ...
        <>
            ...
            <div className="overflow-x-auto border border-orange-300 rounded-lg max-w-[90%] mx-auto block">
                {selectedClass ? (
                    ...
                    >
                        Please select class to manage the marks.
                    </p>
                )}
            </div>

            {selectedClass && postExamList.length > 0 && (
                <>
